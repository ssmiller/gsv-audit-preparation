...
Last revision: 2019-06-12 General processing cleanup
...
def getClosestLineFromServiceArea(maxdist, facilities, datesuffix):
    ...
    field_mappings["kmzid"].mappedFieldName = "kmzid"
    field_mappings["Name"].mappedFieldName = "kmzid"
    ...
    target_field_name = "%s.kmzid" % field_qualifier_lin
    field_qualifier_fac = os.path.basename(facilities_sublayer.dataSource)
    expression = "!%s.kmzid!" % field_qualifier_fac
    print(expression)
    ...
    arcpy.Dissolve_management(out_lines, out_lines_dslv, dissolve_field="kmzid",
